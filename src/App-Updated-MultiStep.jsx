        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="text-center lg:text-left">
            ...
            <p className="text-lg sm:text-xl lg:text-2xl text-white/90 mb-6 sm:mb-8 leading-relaxed">
              Erstellen Sie professionelle Werbekampagnen für alle Plattformen mit unserem 
              intelligenten Wizard. Keine Vorkenntnisse erforderlich.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start mb-8 sm:mb-12">
              <Button 
                onClick={() => setAuthView('register-simple')}
                className="bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 text-black font-bold text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-105 touch-manipulation"
              >
              ...
              <Button 
                variant="outline" 
                className="border-white/30 text-white hover:bg-white/10 backdrop-blur-sm text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 touch-manipulation"
              >
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-4 sm:gap-6 text-sm sm:text-base text-white/80">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-4 sm:mb-6">
            Warum <span className="text-purple-600">Tausende</span> uns vertrauen
          </h2>
    ...
    <section className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 py-8 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          {currentUser?.registrationStep !== 'completed' && (
  ...
  return (
    <div>
      ...
      {authView === 'login' && (
        <LoginForm 
          onLogin={handleLogin} 
          onSwitchToLogin={() => setAuthView('register-simple')}
        />
      )}
