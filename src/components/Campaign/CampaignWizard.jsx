  ...
  const channels = [
    {
      id: 'facebook',
      name: 'Facebook',
      icon: <img src="/logos/facebook.png" alt="Facebook" className="w-12 h-12 object-contain" />,
      format: '1080x1080',
    ...
    },
    {
      id: 'instagram',
      name: 'Instagram',
      icon: <img src="/logos/instagram.png" alt="Instagram" className="w-12 h-12 object-contain" />,
      format: '1080x1080',
      dimensions: '1080x1080px',
      color: 'bg-gray-100'
    },
    {
      id: 'google',
      name: 'Google Ads',
      icon: <img src="/logos/google.png" alt="Google Ads" className="w-12 h-12 object-contain" />,
      format: '1080x1080',
      dimensions: '1080x1080px',
      color: 'bg-gray-100'
    },
    {
      id: 'tiktok',
      name: 'TikTok',
      icon: <img src="/logos/tiktok.png" alt="TikTok" className="w-12 h-12 object-contain" />,
      format: '1080x1920',
    ...
    },
    {
      id: 'snapchat',
      name: 'Snapchat',
      icon: <img src="/logos/snapchat.png" alt="Snapchat" className="w-12 h-12 object-contain" />,
      format: '1080x1920',
      dimensions: '1080x1920px',
      color: 'bg-gray-100'
    },
    {
      id: 'reddit',
      name: 'Reddit',
      icon: <img src="/logos/reddit.png" alt="Reddit" className="w-12 h-12 object-contain" />,
      format: '1200x630',
    ...
    },
    {
      id: 'linkedin',
      name: 'LinkedIn',
      icon: <img src="/logos/linkedin.png" alt="LinkedIn" className="w-12 h-12 object-contain" />,
      format: '1080x1080',
      dimensions: '1080x1080px',
      color: 'bg-gray-100'
    },
    {
      id: 'spotify',
      name: 'Spotify',
      icon: <img src="/logos/spotify.png" alt="Spotify" className="w-12 h-12 object-contain" />,
      format: '1080x1080',
      dimensions: '1080x1080px',
      color: 'bg-gray-100'
    }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 justify-items-center">
              ...
              <div className="text-center w-full">
                <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full text-sm font-medium mb-4 bg-white border-2 border-gray-200 text-gray-900 shadow-sm">
                  ...
                  <span className="font-medium">{selectedChannels[firstIndex]?.name}</span>
                </div>
              ...
              {secondIndex !== null && (
                <div className="text-center w-full">
                  <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full text-sm font-medium mb-4 bg-white border-2 border-gray-200 text-gray-900 shadow-sm">
                    ...
                    <span className="font-medium">{selectedChannels[secondIndex]?.name}</span>
                  </div>
